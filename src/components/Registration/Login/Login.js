      ...
      <section class="text-gray-100 bg-blue-900 body-font">
        <div class="container lg:px-5 mt-4 mx-auto flex flex-wrap items-center">
          ...
          <div class="lg:w-2/6 md:w-1/2 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            <h2 class="text-gray-100 text-xl font-bold font-medium title-font mb-5">
              Log In
            </h2>
            <div class="relative mb-4">
              ...
              <input
                ...
                ref={emailRef}
                required
                class="w-full bg-gray-400 border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <div class="relative mb-4">
              <label for="email" class="leading-7 text-sm text-gray-100">
            ...
            <button
              ...
              class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 text-lg"
            >
              LOGIN
            </button>
            <div>
              <h2 class="text-xs text-indigo-400 tracking-widest font-medium title-font mt-2">
                Already registered?{" "}
