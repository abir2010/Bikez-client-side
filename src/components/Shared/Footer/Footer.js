...
const Footer = () => {
  return (
    <footer class="">
      <div class="container px-5 pb-2 pt-12 mx-auto">
        <div class="flex flex-wrap md:text-left text-center order-first">
          <div class="lg:w-1/4 md:w-1/2 w-full px-4 text-white">
            <div>
              <img src={footer_icon} alt="" />
              <h2 class="font-bold tracking-widest text-2xl mb-3">BIKEZ.</h2>
            </div>
          </div>
          <div class="lg:w-1/4 md:w-1/2 w-full px-4 text-white">
            <h2 class="font-bold tracking-widest text-md mb-3">PAGES</h2>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 class="font-bold tracking-widest text-md mb-3">LINKS</h2>
            <nav class="list-none mb-10">
              <li>
                <a href="/" class="">
                  GALLERY
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4 text-white">
            <h2 class="font-bold tracking-widest text-md mb-3">SUBSCRIBES</h2>
            <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-red-500 bg-white border-0 py-2 px-6 focus:outline-none hover:bg-red-500 hover:text-white">
                SEND
              </button>
            </div>
